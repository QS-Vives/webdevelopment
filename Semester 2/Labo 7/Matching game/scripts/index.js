...
global = {
    ...
    AANTAL_SETS: 500,         // Only for AUTO_DIMENSION = true,      Amount of sets in the game
    AANTAL_HORIZONTAAL: 12,  // Only for AUTO_DIMENSION = false (*), Amount of cards in a row
...
const ig_generate_new_image = () => {
    let loading_element = document.getElementById("loading_message");
    loading_element.innerText = loading_element.innerText + "."
    loading_element.innerText = loading_element.innerText.replace("...", "");
    let ig_image_id = "";
    let image_number_1;
    let image_number_2;
    let hue_1;
